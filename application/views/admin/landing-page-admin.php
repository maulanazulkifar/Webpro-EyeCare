      ...
      <div class="modal fade" id="tambahDokter">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="<?php echo base_url() ?>Admin/c_admin/tambah_dokter" method='post'>
              <div class="modal-body">
                <div class="form-group">
                  <label for="name">Nama Dokter</label>
                  <input type="text" class="form-control" id="namadokter" name="nama">
                </div>
                <div class="form-group">
                  <label for="name">Jadwal 1</label>
                  <input type="text" class="form-control" id="jadwal1" name="jadwal1">
                </div>
                <div class="form-group">
                  <label for="name">Jadwal 2</label>
                  <input type="text" class="form-control" id="jadwal2" name="jadwal2">
                </div>
                <div class="form-group">
                  <label for="name">Jadwal 3</label>
                  <input type="text" class="form-control" id="jadwal3" name="jadwal3">
                </div>
              </div>
      ...
      <table class="table table-hover table-bordered">
        ...
        <tbody>
          <tr>
            ...
            <td><?php echo $d->jadwal1 ?></td>
            <td><?php echo $d->jadwal2 ?></td>
            <td><?php echo $d->jadwal3 ?></td>
            <td class="text-center"><a href="<?php echo base_url() ?>Admin/c_admin/hapus/<?php echo $d->id_dokter ?>" onclick="return confirm('Anda Yakin?')"><button class="btn btn-danger" >Hapus</button></a></td>
            <td>
                ...
                <div class="modal fade" id="editDokter">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <form action="<?php echo base_url() ?>Admin/c_admin/update/<?php echo $d->id_dokter ?>" method="post">
                        <div class="modal-body">
                          <div class="form-group">
                            <label for="name">Nama Dokter</label>
                            <input type="text" class="form-control" id="namadokter"  name="nama">
